          ...
          <tr>
            ...
            <td width="100%" align="right" valign="top"><!-- InstanceBeginEditable name="EditRegion3" -->
              <table width="99%" border="0" align="right" cellpadding="0" cellspacing="0" class="blackBorder">
                <tr>
                  <td height="25" align="center" valign="middle" bgcolor="#000000"><div align="center" class="white"><strong>HISTORY DOWNLOADS</strong></div></td>
                </tr>
                <tr>
                  <td align="center" valign="top" bgcolor="#666666"><br>
                    ...
                    <table width="100" border="0" align="center" cellpadding="0" cellspacing="0" class="blackBorder">
                      <tr>
                        ...
                        <td align="center" nowrap bgcolor="#000000" class="white">&nbsp;Os&nbsp;</td>
                        <td align="center" nowrap bgcolor="#000000" class="white">&nbsp;Browsers&nbsp;</td>
                        <td align="center" nowrap bgcolor="#000000" class="white">&nbsp;Languages&nbsp;</td>
                        <td align="center" nowrap bgcolor="#000000" class="white">&nbsp;Injections&nbsp;</td>
                      </tr>
                     <?php 
					  	if(count($cuntryArray)>0){ 
							for($i=0; $i<count($cuntryArray); $i++){
								$arrayCount = $downloads->getCount($cuntryArray[$i]);
								
								echo "<tr>\n";
								echo "<td align=\"left\" nowrap class=\"white\">&nbsp;".$cuntryArray[$i]."&nbsp;</td>\n";
								echo "<td align=\"center\" nowrap class=\"white\">&nbsp;".$arrayCount["os"]."&nbsp;</td>\n";
								echo "<td align=\"center\" nowrap class=\"white\">&nbsp;".$arrayCount["browsers"]."&nbsp;</td>\n";
								echo "<td align=\"center\" nowrap class=\"white\">&nbsp;".$arrayCount["languages"]."&nbsp;</td>\n";
								echo "<td align=\"center\" nowrap class=\"white\">&nbsp;".$arrayCount["injections"]."&nbsp;</td>\n";
							  	echo "</tr>\n";
							}
						}
						else{
